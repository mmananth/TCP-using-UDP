...
void calculate_RTO(unsigned int seq_number)
{
...
int send_data_troll(unsigned index)
{
	...
	printf("Sent %u sequence data from tcpd_m2 to timer sec %u timesec %u\n",timer_data.seq_no,
			timer_data.AERT.tv_sec, cb.sent_time[index].tv_sec );
